---
layout: page
title: 1. Pure Controls & Systems Theory
permalink: /roadmap-pure-controls/
---
...
<div class="timeline">
    <div class="timeline-item left">
        <div class="timeline-content">
            ...
            <h4>Electives (1)</h4>
            <ul>
                <li>SC 613: Multivariable Control</li>
            </ul>
        </div>
    </div>
    ...
    <div class="timeline-item right">
        <div class="timeline-content">
            ...
            <h4>Electives (2)</h4>
            <ul>
                <li>SC 624: Geometric Methods</li>
                <li>SC 623: Optimal & Robust Control</li>
            </ul>
        </div>
    </div>
    ...
    <div class="timeline-item left">
        <div class="timeline-content">
            ...
            <h4>Electives (2)</h4>
            <ul>
                <li>SC 618: Analytic Dynamics</li>
                <li>SC 617: Adaptive Control</li>
            </ul>
            <h4>Project</h4>
            <ul>
                <li>MTP Stage 1</li>
