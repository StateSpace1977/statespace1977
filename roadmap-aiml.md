...
<div class="timeline">
    <div class="timeline-item left">
        <div class="timeline-content">
            ...
            <ul>
                <li>SC 655: Random Processes in ML</li>
                <li>SC 625: Systems Theory</li>
            </ul>
            <h4>Electives (1)</h4>
            <ul>
                <li>CS 725: Foundations of ML</li>
            </ul>
        </div>
    </div>
    ...
    <div class="timeline-item right">
        <div class="timeline-content">
            ...
            <h4>Electives (1)</h4>
            <ul>
                <li>SC 646: Distributed Opt & ML</li>
            </ul>
        </div>
    </div>
    ...
    <div class="timeline-item left">
        <div class="timeline-content">
            ...
            <h4>Electives (3)</h4>
            <ul>
                <li>CS 748: Advanced ML</li>
                <li>CS 747: Reinforcement Learning</li>
                <li>CS 728: Computer Vision</li>
            </ul>
            <h4>Project</h4>
            <ul>
                <li>MTP Stage 1</li>
