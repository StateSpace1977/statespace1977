...
<div class="tabs-wrapper">
  <div class="year-filter-bar">
    ...
    <select id="alumni-year-select" class="year-select-dropdown" onchange="selectAlumniTab(this.value)">
      ...
      <option value="batch-2022">2022 Graduates (1)</option>
      <option value="batch-2021">2021 Graduates (3)</option>
      <option value="batch-2020">2020 Graduates (1)</option>
      <option value="batch-2019">2019 Graduates (2)</option>
      <option value="batch-2018">2018 Graduates (3)</option>
      <option value="batch-2017">2017 Graduates (1)</option>
      <option value="batch-2016">2016 Graduates (1)</option>
      <option value="batch-2014">2014 Graduates (2)</option>
    ...
    <div class="quick-year-pills">
      <button class="quick-pill active" data-target="batch-2026" onclick="selectAlumniTab('batch-2026')">2026</button>
      <button class="quick-pill" data-target="batch-2025" onclick="selectAlumniTab('batch-2025')">2025</button>
  ...
  <div id="batch-2026" class="tab-pane active">
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Anuj Yadav.jpg" alt="Anuj Yadav" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Anupam.jpg" alt="Anupam" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Chanakya vihar Challa.jpg" alt="Chanakya vihar Challa" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Chandra Vikas.jpg" alt="Chandra Vikas" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Jatinkumar.jpg" alt="Jatinkumar" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Kadapalla Nithin Kumar.jpg" alt="Kadapalla Nithin Kumar" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Paras Pandey.jpg" alt="Paras Pandey" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Prabhat Patel.jpg" alt="Prabhat Patel" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Prashik Patil.jpg" alt="Prashik Patil" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/Rohit kumar.jpg" alt="Rohit kumar" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; padding: 20px; margin-bottom: 16px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
  <div style="flex: 0 0 120px; width: 120px;">
    <img src="/assets/students/24/vinayak bhardwaj.jpg" alt="vinayak bhardwaj" onerror="this.onerror=null; this.src='/assets/avatar/avatar.png';" style="width: 100%; height: auto; display: block; border-radius: 4px;">
  </div>
  <div style="flex: 1; min-width: 240px; display: flex; flex-direction: column; gap: 6px;">
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2025 Graduates</span>
    </div>
</div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2024 Graduates</span>
    </div>
</div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2023 Graduates</span>
    </div>
</div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2022 Graduates</span>
    </div>
</div>
  </div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2021 Graduates</span>
    </div>
</div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2020 Graduates</span>
    </div>
</div>
  </div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2019 Graduates</span>
    </div>
</div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2018 Graduates</span>
    </div>
</div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2017 Graduates</span>
    </div>
</div>
  </div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2016 Graduates</span>
    </div>
</div>
  </div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2014 Graduates</span>
    </div>
</div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">2005 Graduates</span>
    </div>
</div>
  </div>
...
<div class="student-card" style="display: flex; flex-direction: column; padding: 20px; border: 1px solid var(--card-border-color, rgba(0,0,0,0.08)); border-radius: 12px; background: var(--card-bg, rgba(255,255,255,0.02)); box-shadow: 0 2px 8px rgba(0,0,0,0.02); transition: transform 0.2s ease, box-shadow 0.2s ease;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; align-items: center;">
      <span style="background-color: var(--tag-bg, rgba(52, 152, 219, 0.12)); color: var(--link-color, #3498db); padding: 3px 10px; border-radius: 20px; font-size: 0.8em; font-weight: 600;">1999 Graduates</span>
    </div>
</div>
  </div>
