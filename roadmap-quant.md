...
<div class="timeline">
    <div class="timeline-item left">
        <div class="timeline-content">
            ...
            <ul>
                <li>SC 655: Random Processes</li>
                <li>SC 639: Math Structures</li>
            </ul>
            <h4>Electives (1)</h4>
            <ul>
                <li>IE 609: Math Optimisation</li>
            </ul>
        </div>
    </div>
    ...
    <div class="timeline-item right">
        <div class="timeline-content">
            ...
            <h4>Electives (2)</h4>
            <ul>
                <li>IE 616: Game Theory</li>
                <li>IE 708: Markov Decision Processes</li>
            </ul>
        </div>
    </div>
    ...
    <div class="timeline-item left">
        <div class="timeline-content">
            ...
            <h4>Electives (2)</h4>
            <ul>
                <li>SC 631: Games and Information</li>
                <li>IE 611: Stochastic Models</li>
            </ul>
            <h4>Project</h4>
            <ul>
                <li>MTP Stage 1</li>
